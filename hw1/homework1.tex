...
As the transition relation is \textit{deterministic}, we can only arrive at a
unique reduced numeral for a given expression $\E$.

An alternate argument is that we already showed the \textit{denotational
semantics}.
